    library(MST)
      ...
      print(paste("Full"))
      save(fit_results, file = "F:/My Drive/Projects_27092022/Ovarian cancer project/Results/trees_multivariate_with_significant_CESs_HGSOC_iterations_2.RData")
      ...
      (tree_final <- getTree(full_tree, "0"))
      pdf(paste(" F:/My Drive/Projects_27092022/Ovarian cancer project/Plots/Survival\ related\ plots/Tree_multivariate_HGSOC_full_tree_iteration_2.pdf", sep = ""), height = 10, width = 20)
      print(plot(tree_final))
      dev.off()
      
      save.image(" F:/My Drive/Projects_27092022/Ovarian cancer project/Results/Survival\ analysis/trees_multivariate_with_HGSOC_significant_CESs_iteration_2.RData")
